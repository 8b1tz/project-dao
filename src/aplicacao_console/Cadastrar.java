...
public class Cadastrar {
	...
	public Cadastrar() {
		try {
			...
			vi05 = Fachada.cadastrarVideo("https://www.youtube.com/watch?v=Ucyx_QPfDng&list=PLHz_AreHm4dkqe2aR0tQK74m8SFe-aGsY&index=2",
					"Curso POO Teoria  - Aula - 01B", "aula");
			vi06 = Fachada.cadastrarVideo("https://www.youtube.com/watch?v=aR7CKNFECx0&list=PLHz_AreHm4dkqe2aR0tQK74m8SFe-aGsY&index=3",
